          ...
          <template v-if="!uploadResult">
            ...
            <div class="fmt-hint">
              ...
              <div class="fh-item">
                ...
                <span><strong>KXT模板</strong> — 下载模板手动填写四列格式</span>
              </div>
            </div>
            ...
            <div class="form-row">
              ...
              <input type="file" accept=".xlsx" @change="e => upFile = e.target.files[0]" style="padding:7px 10px" />
            </div>
