...
<template>
  <nav :class="['sidebar', collapsed ? 'collapsed' : '', mobileOpen ? 'mobile-open' : '']"
    ...
    <div class="nav-links">
      ...
      <router-link v-if="auth.canPage('ar_analytics')" to="/caiwu/project-cashflow" class="nav-item" :class="{ active: route.path === '/caiwu/project-cashflow' }" @click="onNavClick">
        <span class="nav-icon">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/>
          </svg>
        </span>
        <Transition name="label-fade"><span v-if="!effectiveCollapsed" class="nav-label">项目现金流</span></Transition>
        <Transition name="label-fade"><span v-if="!effectiveCollapsed" class="nav-arrow"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M9 18l6-6-6-6"/></svg></span></Transition>
      </router-link>
      ...
      <router-link v-if="auth.isSuperAdmin" to="/audit" class="nav-item" :class="{ active: route.path === '/audit' }" @click="onNavClick">
        <span class="nav-icon">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
