...
import { BarChart, LineChart, PieChart, ScatterChart, FunnelChart, SankeyChart } from 'echarts/charts'
import {
...
echarts.use([BarChart, LineChart, PieChart, ScatterChart, FunnelChart, SankeyChart,
  GridComponent, TooltipComponent, LegendComponent,
  MarkLineComponent, MarkAreaComponent, MarkPointComponent,
  DataZoomComponent, VisualMapComponent, GraphicComponent,
  CanvasRenderer])
