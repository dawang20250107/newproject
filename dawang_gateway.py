...
async def _patched_runner_start(self) -> bool:
    ...
    if result:
        engine = ProactiveEngineV3(self)
        self._proactive_engine = engine
        await engine.start()
        logger.info("🔥 ProactiveEngine V2 injected into GatewayRunner (10 systems: emotion/dream/desire/meta/memory/persona/narrative/tom/aesthetic/value)")
    return result
